...
DESCRIPTIONS = {
    "within_cluster_dists": "Sum of within cluster distances for each instance. The medoid "
...
def dictionarize(value: t.Any, auxiliar_value: t.Any, auxiliar_key: str) -> t.Dict[str, t.Any]:
    res = {
        "value": value,
...
def add_desc(value: t.Any, desc: t.Optional[str] = None, from_id: t.Optional[t.Any] = None) -> t.Dict[str, t.Any]:
