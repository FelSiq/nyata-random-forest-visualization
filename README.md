...
The [visualization_example.ipynb](visualization_example.ipynb) jupyter notebook have some examples demonstrating the `nyata.dump` usage for Random Forests and Decision Trees.
